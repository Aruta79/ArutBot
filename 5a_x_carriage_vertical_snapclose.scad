...
module x_carriage_vertical(front = true)
{
	...
	difference()
	{
		union()
		{
			...
			if (front)
			{
				translate([(x_carriage_width-x_carriage_belt_clip_width)/2, -lm10uu_dia/2 - thin_wall/2, x_carriage_height-lm10uu_dia/2-wall]) x_carriage_belt_clip();
			}
		}
...
module x_carriage_belt_clip()
{
	difference()
	{
		translate([0, (x_carriage_depth - x_carriage_belt_clip_depth)/2, 0]) cube([x_carriage_belt_clip_width, x_carriage_belt_clip_depth, x_carriage_belt_clip_height]);

		translate([-1, x_carriage_depth-thin_wall/2 - (x_carriage_belt_hole - belt_thickness) + x_carriage_belt_dist/2 + 0.5 + x_carriage_belt_offset, thin_wall-0.5]) cube([x_carriage_belt_clip_width+2, x_carriage_belt_hole, x_carriage_belt_clip_height+1]);
		translate([-1, x_carriage_depth-thin_wall/2 - x_carriage_belt_dist/2+x_carriage_belt_offset, thin_wall-0.75]) cube([x_carriage_belt_clip_width+2, x_carriage_belt_hole, x_carriage_belt_clip_height+1]);
...
translate([0, 15, 0]) x_carriage_belt_cap();
